<template>
  <div class="container">
    <h2>뉴스 수정</h2>
      <b-form @submit.prevent="newNewsArticle">
        ...
        <b-button class="btn btn-outline-dark" @click="putNewsArticle" variant="light">수정 완료</b-button>
      </b-form>
...
export default {
  ...
  methods: {
    ...
    putNewsArticle() {
      ...
      this.$nextTick(() => {
        this.$router.push(`/community/newsboard/${ this.$route.params.id }`);
      });
    }
  }
}
